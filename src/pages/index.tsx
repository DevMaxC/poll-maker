            ...
            {options.map((option, index) => (
              <div key={index} className="w-full relative">
                <input
                  ...
                  className="block p-4 w-full text-gray-900 bg-gray-50 border-b border-gray-300 sm:text-md focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                ></input>
                <button
                  onClick={() => {
                    setOptions([
